...
import com.sharad.sociox.databinding.ActivityProductDetailsBinding
import com.sharad.sociox.roomDB.AppDatabase
import com.sharad.sociox.roomDB.ProductDao
...
class ProductDetailsActivity : AppCompatActivity() {
    ...
    if (productDao.isExit(proId)!= null){
        binding.textView10.text="Product Already in Cart"
    }else{
