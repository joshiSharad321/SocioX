...
import com.sharad.sociox.Adapter.CategoryAdapter
import com.sharad.sociox.Adapter.ProductAdapter
import com.sharad.sociox.Model.AddProductModel
import com.sharad.sociox.Model.CategoryModel
import com.sharad.sociox.R
import com.sharad.sociox.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.sliderimg.setOnClickListener{
    ...
    private fun getCategories() {
        ...
        Firebase.firestore.collection("categories")
            .get().addOnSuccessListener {
                ...
                binding.categoryRecyler.adapter= CategoryAdapter(requireContext(),list)
            }
    }
}